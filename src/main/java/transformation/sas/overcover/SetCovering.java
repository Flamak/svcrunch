...
public class SetCovering {
    ...
    static Comparator listSizeComparator = new Comparator() {
        @Override
        public int compare(Object a, Object b) {
            LinkedList<StandardAtom> aa = (LinkedList<StandardAtom>) a,
                    bb = (LinkedList<StandardAtom>) b;
            return bb.size() - aa.size();
        }
    };
    static Comparator listWrapperSizeComparator = new Comparator() {
        @Override
        public int compare(Object a, Object b) {
            ListWrapper aa = (ListWrapper) a,
                    bb = (ListWrapper) b;
            return bb.list.size() - aa.list.size();
        }
    };
