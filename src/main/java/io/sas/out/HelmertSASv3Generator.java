...
import representations.SAS.SAction;
import representations.SAS.SAssignment;
import representations.SAS.STransition;
import representations.SAS.SValue;
import representations.SAS.SVariable;
...
public class HelmertSASv3Generator {
    ...
    private static Comparator assignementComparator = new Comparator() {
        @Override
        public int compare(Object a, Object b) {
            SAssignment aa = (SAssignment) a,
                    bb = (SAssignment) b;
            int o = aa.var.GetMyIndex(), t = bb.var.GetMyIndex();
            return o - t;
        }
    };
