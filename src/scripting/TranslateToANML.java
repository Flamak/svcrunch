...
import static scripting.ScriptsGen.generateme;

/**
 *
 * @author FD
 */
public class TranslateToANML {
    ...
    public static void main(String[] args) {
        ...
        String inputDirectory = "C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/pddlLarge/";
        String outputDirectory = "C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlLarge/";
        String templatePath = "C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/elevatorsTemplate.anml";
        if (args.length == 2) {
