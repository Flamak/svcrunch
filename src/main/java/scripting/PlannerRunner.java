...
//import freeLunch.planning.cmdline.SasSolver;
//import freeLunch.planning.sase.sasToSat.SasParser;
import java.io.File;
...
public class PlannerRunner {
    ...
    public static void run(String path, int timeLimit) throws InterruptedException, ExecutionException{
        ...
        for (File f : problems) {
            ...
            try {
                ...
                String ret = future.get(timeLimit, TimeUnit.SECONDS);
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException, java.util.concurrent.TimeoutException {
        ...
        //run("C:/ROOT/PROJECTS/pddlParser/data/mySAS", 5*60);
        //run("mySAS", 5*60);
        //run("helmertSAS", 5*60);
    }
}
